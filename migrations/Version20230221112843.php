 ...
 */
final class Version20230221112843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, class_id INT DEFAULT NULL, class_time_id INT DEFAULT NULL, teacher_id INT DEFAULT NULL, subject_id INT DEFAULT NULL, place VARCHAR(64) NOT NULL, date DATE NOT NULL, INDEX IDX_5A3811FBEA000B10 (class_id), INDEX IDX_5A3811FB9B9FBAC7 (class_time_id), INDEX IDX_5A3811FB41807E1D (teacher_id), INDEX IDX_5A3811FB23EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
